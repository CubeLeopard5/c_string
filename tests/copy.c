...
Test(copy, copies_string_to_buffer) {
    ...
    char buffer[10];
    size_t result = str.copy_c(&str, buffer, 5, 0);
...
Test(copy, handles_start_position) {
    ...
    char buffer[10];
    size_t result = str.copy_c(&str, buffer, 3, 2);
...
Test(copy, handles_exceeding_buffer_size) {
    ...
    char buffer[10];
    size_t result = str.copy_c(&str, buffer, 10, 0);
...
Test(copy, returns_actual_length_copied) {
    ...
    char buffer[10];
    size_t result = str.copy_c(&str, buffer, 5, 3);
